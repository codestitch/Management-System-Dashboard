<?php
	...
	**/
	...
	// header('Access-Control-Allow-Origin: 192.168.1.25');

	/********** Front-End **********/
	define('MERCHANT', 'Blackbeard\'s Seafood Island');


	/********** Front-End **********/
	define('MERCHANT_APPNAME', 'SEAFOOD');


	/********** MERCHAT-Website **********/
	define('MERCHANT_LINK', 'http://seafood-island.com/');
	define('MERCHANT_WEBLABEL', 'www.seafood-island.com');
	...
	/********** Apple Push **********/
	define('CERTIFICATE', 'seafood-dev.pem');
