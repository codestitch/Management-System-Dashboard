<?php
	...
	require_once('php/api/dashboard/class/dashboard.class.php');
	...
	switch ($function) {
		...
		case 'add_press':
			...
			echo $class->add_press($accountID, $my_session_id, $image, $status);
			die();
			break;
		...
		case 'delete_press':
			...
			if (isset($_POST['pressID']) && $_POST['pressID'] != NULL) {
				$pressID = $cipher->decrypt($_POST['pressID']);
				$pressID = filter_var($pressID, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
			} else {
				api_error_logger('(pressID: '.$_POST['pressID'].')');
				echo $error400;
				die();
			}
			
			echo $class->delete_press($accountID, $my_session_id, $pressID);
			die();
			break;
		...
		case 'update_press':
			...
			echo $class->update_press($accountID, $my_session_id, $pressID, $image, $status);
			die();
			break;
		...
		case 'add_promo':
			...
			echo $class->add_promo($accountID, $my_session_id, $name, $image, $status);
			die();
			break;
		...
		case 'update_promo':
			...
			echo $class->update_promo($accountID, $my_session_id, $promoID, $name, $image, $status);
			die();
			break;
		...
		case 'add_loyalty':
			...
			echo $class->add_loyalty($accountID, $my_session_id, $name, $points, $terms, $description, $status);
			die();
			break;
		...
		case 'update_loyalty':
			...
			echo $class->update_loyalty($accountID, $my_session_id, $loyaltyID, $name, $points, $terms, $description, $status);
			die();
			break;
		...
		case 'add_staff':
			...
			echo $class->add_staff($accountID, $my_session_id, $name, $description, $image, $status);
			die();
			break;
		...
		case 'delete_staff':
			...
			if (isset($_POST['staffID']) && $_POST['staffID'] != NULL) {
				$staffID = $cipher->decrypt($_POST['staffID']);
				$staffID = filter_var($staffID, FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
			} else {
				api_error_logger('(staffID: '.$_POST['staffID'].')');
				echo $error400;
				die();
			}
			
			echo $class->delete_staff($accountID, $my_session_id, $staffID);
			die();
			break;
		...
		case 'update_staff':
			...
			echo $class->update_staff($accountID, $my_session_id, $staffID, $name, $description, $image, $status);
			die();
			break;
		...
		case 'add_location':
			...
			echo $class->add_location($accountID, $my_session_id, $name, $address, $latitude, $longitude, $branch, $phone, $email, $status, $loyalty, $image);
			die();
			break;
		...
		case 'update_location':
			...
			echo $class->update_location($accountID, $my_session_id, $locID, $name, $address, $latitude, $longitude, $branch, $phone, $email, $status, $loyalty, $image);
			die();
			break;
		...
		case 'delete_product':
			...
			echo $class->delete_product($accountID, $my_session_id, $prodID);
			die();
			break;
		...
		case 'update_profile_info':
			...
			if (isset($_POST['mname1']) && $_POST['mname1'] != NULL) {
		...
		case 'update_profile_logo':
			...
			if (isset($_POST['profilePic']) && $_POST['profilePic'] != NULL) {
		...
		case 'add_sku':
			...
			echo $class->add_sku($accountID, $my_session_id, $name, $skuCode, $price, $promoType, $points, $description, $status);
			die();
			break;
		...
		case 'update_sku':
			...
			echo $class->update_sku($accountID, $my_session_id, $skuID, $name, $skuCode, $price, $points, $description, $status);
			die();
			break;
