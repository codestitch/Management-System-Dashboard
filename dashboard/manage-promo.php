							...
							<div class="table-scrollable">
								...
								<tbody id="bodyTable">
									...
									<tr dir-paginate="item in items | filter:q | orderBy: 'name':true | itemsPerPage: pageSize" current-page="currentPage">
										...
										<td><a href="#" data-ng-click="editObject( item.promoID )" class='btn default btn-xs black'> 
			...
			<div class="modal fade" id="basicedit" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title" id="serviceTitle">Promo Information</h4>
