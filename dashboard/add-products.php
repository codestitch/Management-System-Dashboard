								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div name="summernote" id="serviceDescField"></div>
									...
									<div class="col-md-12">
										...
										<div class="col-md-6">
											<div class="form-group form-md-line-input form-md-floating-label has-info">
												...
												<label for="nameField">Menu Name</label>
												<span class="help-block">Write the Menu Name Here...</span>
											</div>

										<!-- 	<div class="form-group form-md-line-input form-md-floating-label has-info">
												<input type="text" class="form-control" id="priceField" value="0.00">
											...
											<div class="form-group form-md-line-input has-info">
												...
												<label for="categoryField">Menu</label>
											</div>
