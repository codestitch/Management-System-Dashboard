				...
				<div class="col-md-12" id="bodyContent">
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">Manage Location</div>
						...
						<div id="MyController" class="portlet-body" ng-controller="MyController" ng-init="onInitTable()">
							...
							<div class="row">
					            <div class="col-xs-4">
					              <h3>Location Page: {{ currentPage }}</h3>
					            </div>
					            <div class="col-xs-4">
							...
							<div class="table-scrollable">
								...
								<tbody id="bodyTable">
									...
									<tr dir-paginate="item in items | filter:q | orderBy: 'name':true | itemsPerPage: pageSize" current-page="currentPage">
										<td>{{ item.locName }}</td>
										<td>
										...
										<td>
											<span ng-if="item.locFlag == 'active'" class='label label-sm label-success'> {{ item.locFlag | uppercase }} </span>
											<span ng-if="item.locFlag == 'inactive'" class='label label-sm label-danger'> {{ item.locFlag | uppercase }} </span>
										</td>
										<td><a href="#" data-ng-click="editObject( item.locID )" class='btn default btn-xs black'> 
			...
			<div class="modal fade" id="basicedit" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title" id="serviceTitle">Location Information</h4>
